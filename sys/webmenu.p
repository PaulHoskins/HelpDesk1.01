...
/***********************************************************************
    ...
    Program:        sys/webmenu.p
    
    Purpose:        Menu Maintenance     
...
------------------------------------------------------------------------------*/
    ...
    {&out} htmlib-Header("Maintain Web Menu") skip.

    {&out} htmlib-JScript-Maintenance() skip.

    {&out} htmlib-StartForm("mainform","post", appurl + '/sys/webmenu.p' ) skip.

    {&out} htmlib-ProgramTitle("Maintain Web Menu") skip.
    

     {&out}
        tbar-StandardBar(
            appurl + "/sys/webmenu.p",
            appurl + "/sys/webmenumnt.p",
            lc-link-otherp
            ).
    ...
    repeat while avail b-query:
        ...
        {&out}
            ...
            skip
            htmlib-MntTableField(html-encode(b-query.pagename),'left')
            htmlib-MntTableField(html-encode(b-query.pagedesc),'left')
            tbar-StandardRow(
                rowid(b-query),
                lc-user,
                appurl + "/sys/webmenumnt.p",
