...
DEFINE BUFFER b-valid FOR ptt_def.
DEFINE BUFFER b-table FOR ptt_def.
...
PROCEDURE ip-Validate :
    ...
    DO:
        ...
        IF CAN-FIND(FIRST b-valid
            WHERE b-valid.TaskCode = lc-groupid
...
------------------------------------------------------------------------------*/
    ...
    DO:
        ...
        DO:
            ...
            set-user-field("nexturl",appurl + "/sys/webprojtask.p").
    ...
    DO:
        ...
        DO:
            ...
            DO:
                ...
                DO:
                    CREATE b-table.
                    ASSIGN 
                        b-table.TaskCode = CAPS(lc-groupid)
        ...
        DO:
            ...
            RUN run-web-object IN web-utilities-hdl ("sys/webprojtask.p").
            RETURN.
        END.
    END.
    ...
    {&out} htmlib-Header(lc-title) skip
           htmlib-StartForm("mainform","post", appurl + '/sys/webprojtaskmnt.p' )
