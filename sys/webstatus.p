...
/***********************************************************************
    ...
    Program:        sys/webstatus.p
    
    Purpose:        Issue Status Maintenance         
...
def buffer b-query for webstatus.
def buffer b-search for webstatus.
    ...
    do:
        find first b-search 
             where b-search.CompanyCode = lc-global-company
               and b-search.statuscode >= lc-search no-lock no-error.
