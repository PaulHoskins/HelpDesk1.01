...
DEFINE BUFFER b-query  FOR ptt_def.
DEFINE BUFFER b-search FOR ptt_def.
...
------------------------------------------------------------------------------*/
    ...
    {&out}
    tbar-StandardBar(
        appurl + "/sys/webprojtask.p",
        appurl + "/sys/webprojtaskmnt.p",
        lc-link-otherp
        ).
        ...
        ELSE
            ...
            DO:
                FIND FIRST b-search 
                    ...
                    AND b-search.TaskCode >= lc-search NO-LOCK NO-ERROR.
    ...
    REPEAT WHILE AVAILABLE b-query:
        ...
        {&out}
            ...
            skip
            htmlib-MntTableField(html-encode(b-query.TaskCode),'left')
    ...
    {lib/navpanel.i "sys/webprojtask.p"}
