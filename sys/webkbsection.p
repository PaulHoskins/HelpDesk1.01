...
def buffer b-query for knbsection.
def buffer b-search for knbsection.
...
------------------------------------------------------------------------------*/
    ...
    {&out} htmlib-Header("Maintain KB Section") skip.

    {&out} htmlib-JScript-Maintenance() skip.

    {&out} htmlib-StartForm("mainform","post", appurl + '/sys/webkbsection.p' ) skip.

    {&out} htmlib-ProgramTitle("Maintain KB Section") skip.
    
    {&out}
        tbar-StandardBar(
            appurl + "/sys/webkbsection.p",
            appurl + "/sys/webkbsectionmnt.p",
            lc-link-otherp
            ).
    ...
    repeat while avail b-query:
        ...
        {&out}
            ...
            skip
            htmlib-MntTableField(html-encode(b-query.knbcode),'left')
    ...
    {lib/navpanel.i "sys/webkbsection.p"}
