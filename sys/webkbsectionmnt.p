...
def buffer b-valid for knbsection.
def buffer b-table for knbsection.
...
def var lc-default      as char no-undo.
...
------------------------------------------------------------------------------*/
    ...
    case lc-mode:
        ...
        then assign lc-title = 'Delete'
                    ...
                    lc-submit-label = 'Delete Section'.
        when 'Update'
        then assign lc-title = 'Update'
                    lc-link-label = 'Cancel update'
                    lc-submit-label = 'Update Section'.
    end case.


    assign lc-title = lc-title + ' KB Section'
           lc-link-url = appurl + '/sys/webkbsection.p' + 
                                  '?search=' + lc-search + 
                                  '&firstrow=' + lc-firstrow + 
                                  '&lastrow=' + lc-lastrow + 
                                  '&navigation=refresh' +
    ...
    do:
        ...
        do:
            ...
            set-user-field("nexturl",appurl + "/sys/webkbsection.p").
    ...
    do:
        ...
        do:
            assign lc-knbcode   = get-value("knbcode")
            ...
            do:
                ...
                do:
                    create b-table.
                    assign b-table.knbcode      = caps(lc-knbcode)
        ...
        do:
            ...
            RUN run-web-object IN web-utilities-hdl ("sys/webkbsection.p").
            return.
        end.
    end.
    ...
    do:
        ...
        assign lc-knbcode = b-table.knbcode.
    ...
    {&out} htmlib-Header(lc-title) skip
           htmlib-StartForm("mainform","post", appurl + '/sys/webkbsectionmnt.p' )
    ...
    {&out} '<TD VALIGN="TOP" ALIGN="left">'
           htmlib-InputField("knbcode",20,lc-knbcode) skip
           '</TD>'.
    else
    {&out} htmlib-TableField(html-encode(lc-knbcode),'left')
           skip.
