...
def buffer b-valid  for ivSub.
def buffer b-table  for ivSub.
...
------------------------------------------------------------------------------*/
    ...
    assign lc-title = lc-title + ' Inventory Sub Classification - '
    ...
    do:
        ...
        do:
            assign lc-subcode   = get-value("subcode")
    ...
    do:
        ...
        assign lc-subcode = b-table.SubCode.
