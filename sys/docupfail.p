...
------------------------------------------------------------------------------*/
    ...
    set-user-field("problem","Problem loading your document, please check the document exists on your PC").


    assign request_method = "GET".
    RUN run-web-object IN web-utilities-hdl ("sys/doclist.p":U).
