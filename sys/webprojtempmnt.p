/***********************************************************************
    ...
    Program:        sys/webprojtempmnt.p
    
    Purpose:        Project Template Maintenance     
...
DEFINE BUFFER b-valid FOR ptp_proj.
DEFINE BUFFER b-table FOR ptp_proj.
    ...
    DO:
        IF lc-groupid = ""
            ...
            THEN RUN htmlib-AddErrorMessage(
                'groupid', 
                'You must enter the template code',
                INPUT-OUTPUT pc-error-field,
                INPUT-OUTPUT pc-error-msg ).
        

        IF CAN-FIND(FIRST b-valid
            WHERE b-valid.ProjCode = lc-groupid
...
------------------------------------------------------------------------------*/
    ...
    CASE lc-mode:
        ...
        THEN 
            ASSIGN 
                ...
                lc-submit-label = 'Delete Template'.
        WHEN 'Update'
        THEN 
            ASSIGN 
                lc-title = 'Update'
                lc-link-label = 'Cancel update'
                lc-submit-label = 'Update Template'.
    END CASE.
    ...
    DO:
        ...
        DO:
            ...
            set-user-field("nexturl",appurl + "/sys/webprojtemp.p").
    ...
    DO:
        ...
        DO:
            ...
            DO:
                ...
                DO:
                    CREATE b-table.
                    ASSIGN 
                        b-table.ProjCode = CAPS(lc-groupid)
        ...
        DO:
            ...
            RUN run-web-object IN web-utilities-hdl ("sys/webprojtemp.p").
            RETURN.
        END.
    END.
    ...
    {&out} htmlib-Header(lc-title) skip
           htmlib-StartForm("mainform","post", appurl + '/sys/webprojtempmnt.p' )
