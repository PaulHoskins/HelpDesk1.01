...
------------------------------------------------------------------------------*/
    ...
    {&out} htmlib-Header("Maintain KB Item") skip.

    {&out} htmlib-JScript-Maintenance() skip.

    {&out} htmlib-StartForm("mainform","post", appurl + '/sys/webkbitem.p' ) skip.
    ...
    repeat while avail b-query:
        ...
        {&out}
            ...
            skip
            htmlib-MntTableField(html-encode(b-query.knbcode + 
                                             " - " + 
                                             knbSection.description),'left')
    ...
    {lib/navpanel.i "sys/webkbitem.p"}
