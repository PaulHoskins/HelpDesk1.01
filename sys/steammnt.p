...
/***********************************************************************
    ...
    Program:        sys/steammnt.p
    
    Purpose:        Support Team Maintenance     
...
def buffer b-valid for steam.
def buffer b-table for steam.
...
------------------------------------------------------------------------------*/
    ...
    do:
        ...
        if can-find(first b-valid
                    where b-valid.st-num = int(lc-st-num)
...
------------------------------------------------------------------------------*/
    ...
    case lc-mode:
        ...
        then assign lc-title = 'Add'
                    ...
                    lc-submit-label = "Add Support Team".
        when 'view'
        ...
        then assign lc-title = 'Delete'
                    ...
                    lc-submit-label = 'Delete Support Team'.
        when 'Update'
        then assign lc-title = 'Update'
                    lc-link-label = 'Cancel update'
                    lc-submit-label = 'Update Support Team'.
    end case.


    assign lc-title = lc-title + ' Support Team'
           lc-link-url = appurl + '/sys/steam.p' + 
                                  '?search=' + lc-search + 
                                  '&firstrow=' + lc-firstrow + 
                                  '&lastrow=' + lc-lastrow + 
                                  '&navigation=refresh' +
    ...
    do:
        ...
        do:
            ...
            set-user-field("nexturl",appurl + "/sys/steam.p").
    ...
    do:
        ...
        do:
            ...
            do:
                ...
                do:
                    create b-table.
                    assign b-table.st-num = INT(lc-st-num)
        ...
        do:
            ...
            RUN run-web-object IN web-utilities-hdl ("sys/steam.p").
            return.
        end.
    end.
    ...
    {&out} htmlib-Header(lc-title) skip
           htmlib-StartForm("mainform","post", appurl + '/sys/steammnt.p' )
    ...
    {&out} '<TD VALIGN="TOP" ALIGN="left">'
           htmlib-InputField("st-num",4,lc-st-num) skip
           '</TD>'.
    else
    {&out} htmlib-TableField(html-encode(lc-st-num),'left')
           skip.
