...
/***********************************************************************
    ...
    Program:        sys/webissgrpmnt.p
    
    Purpose:        Issue Area Group Maintenance       
...
def buffer b-valid for webissagrp.
def buffer b-table for webissagrp.
...
------------------------------------------------------------------------------*/
    ...
    do:
        ...
        then run htmlib-AddErrorMessage(
                    'groupid', 
                    'You must enter the group code',
                    input-output pc-error-field,
                    input-output pc-error-msg ).
        

        if can-find(first b-valid
                    where b-valid.groupid = lc-groupid
...
------------------------------------------------------------------------------*/
    ...
    case lc-mode:
        ...
        then assign lc-title = 'Delete'
                    ...
                    lc-submit-label = 'Delete Group'.
        when 'Update'
        then assign lc-title = 'Update'
                    lc-link-label = 'Cancel update'
                    lc-submit-label = 'Update Group'.
    end case.


    assign lc-title = lc-title + ' Area Group'
           lc-link-url = appurl + '/sys/webissagrp.p' + 
                                  '?search=' + lc-search + 
                                  '&firstrow=' + lc-firstrow + 
                                  '&lastrow=' + lc-lastrow + 
                                  '&navigation=refresh' +
    ...
    do:
        ...
        do:
            ...
            set-user-field("nexturl",appurl + "/sys/webissagrp.p").
    ...
    do:
        ...
        do:
            assign lc-groupid   = get-value("groupid")
            ...
            do:
                ...
                do:
                    create b-table.
                    assign b-table.groupid = caps(lc-groupid)
        ...
        do:
            ...
            RUN run-web-object IN web-utilities-hdl ("sys/webissagrp.p").
            return.
        end.
    end.
    ...
    do:
        ...
        assign lc-groupid = b-table.groupid.
    ...
    {&out} htmlib-Header(lc-title) skip
           htmlib-StartForm("mainform","post", appurl + '/sys/webissagrpmnt.p' )
    ...
    {&out} '<TR><TD VALIGN="TOP" ALIGN="right">' 
           ...
           then htmlib-SideLabelError("Group Code")
           else htmlib-SideLabel("Group Code"))
           '</TD>' skip
           .
