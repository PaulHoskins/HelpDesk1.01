...
DEFINE BUFFER b-query  FOR steam.
DEFINE BUFFER b-search FOR steam.
...
------------------------------------------------------------------------------*/
    ...
    {&out} htmlib-Header("Maintain Support Teams") skip.

    {&out} htmlib-JScript-Maintenance() skip.

    {&out} htmlib-StartForm("mainform","post", appurl + '/sys/steam.p' ) skip.

    {&out} htmlib-ProgramTitle("Maintain Support Teams") skip.
    

    {&out}
    tbar-StandardBar(
        appurl + "/sys/steam.p",
        appurl + "/sys/steammnt.p",
        lc-link-otherp
        ).
