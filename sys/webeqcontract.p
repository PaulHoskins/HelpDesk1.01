...
DEFINE BUFFER b-query  FOR ContractType.
DEFINE BUFFER b-search FOR ContractType.
...
------------------------------------------------------------------------------*/
    ...
    {&out}
    tbar-Begin(
        tbar-Find(appurl + "/sys/webeqcontract.p")
        )
    tbar-Link("add",?,appurl + "/sys/webeqcontractmnt.p",lc-link-otherp)
    tbar-BeginOption()
    tbar-Link("view",?,"off",lc-link-otherp)
    tbar-Link("update",?,"off",lc-link-otherp)
    tbar-Link("delete",?,"off",lc-link-otherp)
    /*             tbar-Link("eqsubcontract",?,"off",lc-link-otherp) */
    tbar-EndOption()
    tbar-End().
        ...
        ELSE
            ...
            DO:
                FIND FIRST b-search 
                    ...
                    AND b-search.ContractNumber >= lc-search NO-LOCK NO-ERROR.
    ...
    REPEAT WHILE AVAILABLE b-query:
        ...
        {&out}
            ...
            tbar-BeginHidden(rowid(b-query))
                ...
                tbar-Link("update",rowid(b-query),appurl + "/sys/webeqcontractmnt.p",lc-link-otherp)
...
/*                                                 )                                                                                      */
    ...
    {lib/navpanel.i "sys/webeqcontract.p"}
