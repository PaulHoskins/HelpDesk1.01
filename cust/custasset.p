...
/***********************************************************************
    ...
    Program:        cust/custasset.p
    
    Purpose:        Customer Maintenance - Asset Browse        
...
def buffer b-search for CustAst.
...
------------------------------------------------------------------------------*/
    ...
    {&out} htmlib-StartForm("mainform","post", appurl + '/cust/custasset.p' ) skip.

    {&out} htmlib-ProgramTitle("Maintain Customer Assets - " + 
                               customer.name) skip.
    ...
    {&out}
            tbar-Begin(
                tbar-Find(appurl + "/cust/custasset.p")
                )
    ...
    do:
        find first b-search
             ...
             and b-search.AssetID >= lc-Search no-lock no-error.
    ...
    repeat while avail b-query:
        ...
        {&out}
            ...
            htmlib-MntTableField(html-encode(string(b-query.cost,">>>>>>>>9.99-")),'right')
    ...
    {lib/navpanel.i "cust/custasset.p"}
