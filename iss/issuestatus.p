...
------------------------------------------------------------------------------*/
    ...
    {&out} replace(htmlib-ProgramTitle("Status Changes"),
    ...
    do:
        ...
        for each b-table no-lock
            ...
            find b-status where b-status.StatusCode = b-table.NewStatusCode
                            and b-status.CompanyCode = b-table.CompanyCode no-lock no-error.
