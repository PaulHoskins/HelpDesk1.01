...
/***********************************************************************
    ...
    Program:        lib/ajaxsimplevalidate.p
...
------------------------------------------------------------------------------*/
    ...
    */
    ...
    case lc-type:
        ...
        do:
            message "Look = " lc-value.
            find customer
                where customer.CompanyCode = lc-CompanyCode
                  and customer.AccountNumber = lc-value
                  no-lock no-error.
            if avail customer
