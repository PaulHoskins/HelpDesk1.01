...
DO WHILE li-balance > 0:
    ...
    ASSIGN ld-lo = DATETIME(lc-temp).
    ASSIGN ld-temp  = ld-date1 - li-balance.
    ...
    DO:
       ...
       /*
       MESSAGE "loop from "
         "balance = " li-balance SKIP
         "Calc = " (li-balance - ( MTIME(ld-date1) - MTIME(ld-lo))) SKIP
         "to " li-balance - ( MTIME(ld-date1) - MTIME(ld-lo)) SKIP
         
         VIEW-AS ALERT-BOX.
         */
         
        ASSIGN li-balance = li-balance - ( MTIME(ld-date1) - MTIME(ld-lo)).
