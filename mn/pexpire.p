...
------------------------------------------------------------------------------*/
  ...
  {&out}
      '<div class="infobox">'
        ...
        '<h2>Your session has expired or your browser does not accept cookies.</h2>'
        '<p style="text-align: center;"><a href="' hostURL '">Click here to login again</a></p>' skip
      '</div>' skip.
  {&OUT}
    "</BODY>":U SKIP
    "</HTML>":U SKIP
